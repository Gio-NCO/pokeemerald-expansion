...
// Flag/var defines
#define DN_FLAG_SEARCHING             FLAG_UNUSED_0x265 // Searching for mon
#define DN_FLAG_DEXNAV_GET            FLAG_UNUSED_0x266 // DexNav shows in start menu
#define DN_FLAG_DETECTOR_MODE         FLAG_UNUSED_0x267 // Allow player to find hidden mons
